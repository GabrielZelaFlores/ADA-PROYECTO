...
# 🎯 Comunidad objetivo
# =======================
comunidad_objetivo = 36
max_nodos_mostrar = 1000  # Limitar cantidad de nodos mostrados
...
# =======================
# 🔗 Kruskal con Union-Find (mejorado)
# =======================
class UnionFind:
...
if not mst_adj:
    print("⚠️ El MST está vacío. Puede que la comunidad no esté conectada.")
    exit()
